...
```json
{
  ...
  "country_time": "en-US",
  "useLocalIamge": true,
  "referralCode": "edW1osjcF4aaeSZHAMBAe",
...
### 5. `answers.txt` 🌐 - Fill with youtube tasks anwsers.
...
> To run the bot, use the following command: `cd cats-main/cats; node meomundep`
